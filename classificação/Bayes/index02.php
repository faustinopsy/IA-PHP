...
$samples = [[0],[1], [8], [11], [12], [14], [17], [18], [40], [50], [65], [90], [85]];
$labels =   ['Z','C', 'C', 'C', 'A', 'A', 'A', 'U', 'U', 'U', 'I', 'I', 'I'];

$classifier->train($samples, $labels);
$idade=isset($_GET['idade']) ? $_GET['idade'] : 0 ;
$result = $classifier->predict([[$idade]]);
echo "essa pessoa  é " . toDesc($result[0][0][0]) . "<br>";
//echo "uma pessoa de 15 ano(s) é " . toDesc($result[1][0][0]) . "<br>";
//echo "uma pessoa de 35 ano(s) é " . toDesc($result[2][0][0]) . "<br>";
//echo "uma pessoa de 70 ano(s) é " . toDesc($result[3][0][0]) . "<br>";
